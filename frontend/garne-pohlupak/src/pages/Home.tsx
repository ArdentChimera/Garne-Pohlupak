			...
			<div className="flex justify-between items-center px-5">
				...
				<div className="flex items-center gap-2">
					...
					<div className="hidden md:block">
						...
						>
							{isAuthenticated ? (
								<LogOut size={20} color="#F8C663" />
							) : (
								<User size={20} color="#F8C663" />
							)}
					...
					<div className="block md:hidden">
						<Button
							...
							icon={
								isAuthenticated ? (
									<LogOut size={24} color="#F8C663" />
								) : (
									<User size={24} color="#F8C663" />
								)
							}
							onClick={handleAuthClick}
						/>
					...
					<Badge
						...
						offset={[-6, -12]}
						className="[&_.ant-badge-count]:bg-[#F8C663]"
					>
						<Button
							type="text"
			...
			<div className="w-full px-4 md:px-8 lg:px-12 py-12 md:py-16 bg-slate-50">
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4 lg:gap-6">
						{["Гърнета", "Паници", "Чинии", "Чаши", "Делви", "Тенджери"].map(
							(category, index) => (
								<Card
									key={index}
									hoverable
											...
											<div>
												...
												<p className="text-xs text-slate-500">
													{item.stockQuantity > 0
														? `В наличност: ${item.stockQuantity}`
														: "Изчерпан"}
												</p>
											</div>
						...
						{[
							{
								...
								rating: 5,
								review:
									"Страхотни гърнета! Майка ми готви в тях всеки ден. Храната е много по-вкусна и ароматна. Автентична българска изработка!",
								date: "Преди 2 дни",
							...
							},
							{
								...
								rating: 5,
								review:
									"Купих комплект гърнета за цялото семейство. Качеството е изключително, точно като на баба ми в селото!",
							...
							},
							{
								...
								rating: 4,
								review:
									"Керамичните делви са много добри за яхния и боб. Единствено доставката беше малко закъсняла, но си заслужава!",
							...
							},
							{
								...
								rating: 5,
								review:
									"Перфектен гювеч! Направих печено месо и беше като от фурна на дърва. Ръчната изработка се вижда и усеща.",
								date: "Преди 3 дни",
							...
							},
							{
								...
								rating: 5,
								review:
									"Паничката е точно това, което ми трябваше за приготвяне на лечо и зимнина. Традиционно качество!",
								date: "Преди 5 дни",
							...
							},
							{
								...
								rating: 4,
								review:
									"Много красиви и качествени гърнета. Чувства се българското майсторство. Препоръчвам на всички!",
								date: "Преди 1 месец",
			...
			<div className="w-full px-4 md:px-8 lg:px-12 py-16 md:py-20 bg-gradient-to-br from-[#F8C663] to-[#f5b940]">
				<div className="max-w-3xl mx-auto text-center">
					...
					<p className="text-slate-700 text-sm md:text-base mb-6 md:mb-8">
						Получавай новини за нови гърнета, рецепти и традиционни техники за
						готвене директно в пощата си
					</p>
			...
			<footer className="w-full px-4 md:px-8 lg:px-12 py-12 md:py-16 bg-slate-900 text-slate-300">
				<div className="max-w-7xl mx-auto">
					...
					<div className="border-t border-slate-800 pt-8 text-center text-sm text-slate-400">
						<p>
							© 2025 Гърне Похлупак - Традиционна българска керамика. Всички
							права запазени.
						</p>
					</div>
				</div>
